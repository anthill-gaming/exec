...
SECRET_KEY = '$qxj&amp;73@yb!9(ld0ns!-o9q4*0%9-h^k-2$$1fll6gc1^4!wkw'
...
SQLALCHEMY_DATABASE_URI = 'postgres://anthill_exec@/anthill_exec'

LOCATION = 'http://localhost:9610'
...
CACHES["default"]["LOCATION"] = "redis://localhost:6379/20"
CACHES["default"]["KEY_PREFIX"] = "exec.anthill"
...
LOGGING = {
    ...
    'handlers': {
        ...
        'anthill.server': {
            ...
            'filename': os.path.join(LOGGING_ROOT_DIR, 'exec.log'),
            'formatter': 'anthill.server',
...
GRAPHENE = {
    'SCHEMA': 'exec.api.v1.public.schema',
    'MIDDLEWARE': ()
}
